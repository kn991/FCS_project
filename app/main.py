...
def update_user_api(user_id: int, user_update: UserCreate, db: Session = Depends(get_db)):
...
def update_product_api(product_id: int, product_update: ProductCreate, db: Session = Depends(get_db)):
...
def update_order_api(order_id: int, order_update: OrderCreate, db: Session = Depends(get_db)):
...
def create_order_item_api(item: OrderItemCreate, order_id: int = Path(...), db: Session = Depends(get_db)):
...
def get_order_item_api(order_id: int, item_id: int, db: Session = Depends(get_db)):
...
def update_order_item_api(order_id: int, item_id: int, item_update: OrderItemCreate, db: Session = Depends(get_db)):
...
def delete_order_item_api(order_id: int, item_id: int, db: Session = Depends(get_db)):
